...
export const RightSideBar = ({
  ...
  return (
    <section className='flex flex-col border-t border-primary-grey-200 bg-primary-black text-primary-grey-300 min-2-[327px] sticky right-0 h-full max-sm:hidden select-none'>
      <h3 className='px-5 pt-4 textxs uppercase'>Design</h3>
